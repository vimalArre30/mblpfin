          ...
          {posts.map((post) => (
            ...
            >
              <div className="flex items-center gap-2">
                <span className="font-inter text-[10px] text-white/40 bg-white/[0.05] px-2 py-0.5 rounded tracking-wide">
                  {post.category}
                </span>
                <span className="font-inter text-[10px] text-white/35">
                  {post.readTime}
                </span>
              </div>
              ...
              <p className="font-inter text-xs text-white/50 leading-relaxed line-clamp-3">
                {post.excerpt}
              </p>
              <span className="font-inter text-xs text-white/40 group-hover:text-white/70 transition-colors mt-auto">
                Read →
              </span>
            </Link>
          ))}
